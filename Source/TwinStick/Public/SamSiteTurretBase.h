...
#include "SamSiteTurretBase.generated.h"
...
class TWINSTICK_API ASamSiteTurretBase : public APowerConsumer, public IDamagable, public IGenericTeamAgentInterface {
    GENERATED_BODY()
public:
    ...
    ASamSiteTurretBase(const FObjectInitializer& ObjectInitializer);
