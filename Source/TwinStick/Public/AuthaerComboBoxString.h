...
#include "AuthaerComboBoxString.generated.h"

class UAuthaerComboBoxStyle;

UCLASS(Blueprintable)
class TWINSTICK_API UAuthaerComboBoxString : public UWidget {
    GENERATED_BODY()
public:
...
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<UAuthaerComboBoxStyle> ComboBoxStyleClass;
