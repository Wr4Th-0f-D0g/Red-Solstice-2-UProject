...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static UFMODAudioComponent* PlayEventAttachedWeapon(UFMODEvent* Event, USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, TEnumAsByte<EAttachLocation::Type> LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoPlay, bool bDetachOnCompletion);
