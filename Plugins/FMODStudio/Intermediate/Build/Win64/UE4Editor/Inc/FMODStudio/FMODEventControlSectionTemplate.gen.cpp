...
#include "FMODStudio/Public/FMODEventControlSectionTemplate.h"
#ifdef _MSC_VER
#pragma warning (push)
...
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventControlSectionTemplate
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/FMODEventControlSectionTemplate.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_Statics::NewProp_ControlKeys_MetaData[] = {
		...
		{ "Category", "FMODEventControlSectionTemplate" },
		{ "ModuleRelativePath", "Public/FMODEventControlSectionTemplate.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_Statics::NewProp_ControlKeys = { "ControlKeys", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFMODEventControlSectionTemplate, ControlKeys), Z_Construct_UScriptStruct_FFMODEventControlChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_Statics::NewProp_ControlKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_Statics::NewProp_ControlKeys_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventControlSectionTemplate_Hash() { return 536533533U; }
