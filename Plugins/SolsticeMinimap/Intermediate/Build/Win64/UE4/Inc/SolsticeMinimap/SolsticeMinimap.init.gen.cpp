...
void EmptyLinkFunctionForGeneratedCodeSolsticeMinimap_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_SolsticeMinimap()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_SolsticeMinimap_MapGenerationComplete__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SolsticeMinimap_OnLargeMapElementHovered__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SolsticeMinimap_OnLargeMapElementUnHovered__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/SolsticeMinimap",
				SingletonFuncArray,
